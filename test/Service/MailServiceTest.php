...
class MailServiceTest extends TestCase
{
    ...
    /**
     * Confirms the existing success path already resets the body — locks in
     * current behavior so a future refactor (e.g. moving the reset into a
     * finally) does not silently regress the success case.
     */
